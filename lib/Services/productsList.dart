...
class ProductList extends StatefulWidget {
  ...
  ProductList(String type , String search){
    this.type = type;
    this.search = search;
  }
...
class _ProductListState extends State<ProductList> {
  ...
  Widget build(BuildContext context) {
    final productsList = Provider.of<List<Product>>(context);
    if(productsList!=null)
      {

          setState(() {
            widget.searchList=productsList.where((element) => (element.name.toLowerCase().contains(widget.search.toLowerCase())
          ...
          if(widget.search==null)
          {
            return  ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ProductTile(product : productsList[index],type: widget.type,);
              },
            );
          }else{
            return  ListView.builder(
